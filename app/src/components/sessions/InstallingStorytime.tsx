...
class InstallingScreen extends React.Component<Props, State> {
  state: State = {
    accountId: null,
    currentUser: null,
  };
  ...
  generateHtmlCode = () => {
    ...
    return `
<script>
  // NOTE: DO NOT copy the window.Timbr.config again if you
    ...
    return (
      ...
      >
        ...
        <Box mb={4}>
          ...
          <Paragraph>
            <Text>
              First, install the <Text code>@timbr/screen</Text>{' '}
              package:
            </Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            >
              <Box p={3}>npm install --save @timbr/screen</Box>
            </pre>
          </Paragraph>
        ...
        <Paragraph>
          <Text>
            ...
            <a
              href="https://github.com/alxshelepenok/screen"
              target="_blank"
