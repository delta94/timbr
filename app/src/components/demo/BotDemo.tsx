...
const DEFAULT_FAQS: Array<FAQ> = [
  ...
  {
    q: 'Who are you?',
    a: "My name is Alex, I'm one of the co-creators of Timbr :)",
  },
  {
    q: 'Where are you?',
...
class Demo extends React.Component<Props, State> {
  ...
  handleNlpDemo = (message: any) => {
    ...
    return request
      .post(`https://timbr-plugin-demo.herokuapp.com/api/demo/nlp`)
      .send({message, faqs})
        ...
        <Box mb={4}>
          ...
          <form onSubmit={this.handleAddNewFaq}>
            ...
            <Box mb={3}>
              ...
              <TextArea
                id="answer"
                placeholder="Hmm... it's gotta be Timbr!"
                value={newAnswer}
        ...
        <Flex mb={4} sx={{alignItems: 'center'}}>
          <Box mr={3}>
            <Text strong>
              ...
              timbr.chat to be notified of its release
            </Text>
          </Box>
          <Link to="/register">
