...
export const isHostedProd = window.location.hostname === 'app.timbr.chat';

export const REACT_URL = process.env.REACT_APP_URL || 'app.timbr.chat';
...
// Defaults to Timbr client ID (it's ok for this value to be public)
