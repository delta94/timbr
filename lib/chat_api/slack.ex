defmodule ChatApi.Slack do
  ...
  def log(message) do
    case System.get_env("TIMBR_SLACK_WEBHOOK_URL") do
  ...
  # Look for a match between the Slack sender and internal Timbr users
  ...
  def get_access_token(code) do
    client_id = System.get_env("TIMBR_SLACK_CLIENT_ID")
    client_secret = System.get_env("TIMBR_SLACK_CLIENT_SECRET")
