defmodule ChatApi.Emails.Email do
  ...
  def welcome(to_address) do
    ...
    |> reply_to("alex@timbr.chat")
    |> subject("Welcome to Timbr!")
  ...
  defp welcome_email_text() do
    ...
    Thanks for signing up for Timbr :)

    I'm Alex, one of the founders of Timbr along with Kam. If you have any questions,
    feedback, or need any help getting started, don't hesitate to reach out!

    Feel free to reply directly to this email, or contact me at alex@timbr.chat

    Best,
    Alex

    We also have a Slack channel if you'd like to see what we're up to :)
    https://github.com/alxshelepenok/timbr#get-in-touch
    """
  end
  ...
  defp welcome_email_html() do
    ...
    <p>Thanks for signing up for Timbr :)</p>

    <p>I'm Alex, one of the founders of Timbr along with Kam. If you have any questions,
    feedback, or need any help getting started, don't hesitate to reach out!</p>

    <p>Feel free to reply directly to this email, or contact me at alex@timbr.chat</p>
  ...
  def password_reset(%ChatApi.Users.User{email: email, password_reset_token: token} = _user) do
    ...
    |> to(email)
    |> from({"Timbr", @from_address})
    |> subject("[Timbr] Link to reset your password")
  ...
  defp get_app_domain() do
    if Mix.env() == :dev do
      ...
      "https://" <> System.get_env("BACKEND_URL", "app.timbr.chat")
    end
  end
  ...
  defp password_reset_text(token) do
    ...
    Click the link below to reset your Timbr password:
  ...
  defp password_reset_html(token) do
    ...
    <p>Click the link below to reset your Timbr password:</p>
